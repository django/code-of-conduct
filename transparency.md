# Django Code of Conduct - Transparency
...
- [Working Group Manual](working-group-manual.md) - Our complete internal procedures and guidelines
- [Reporting Guide](reporting-guide.md) - How to report Code of Conduct violations
- [Enforcement Ladder](enforcement-ladder.md) - The range of enforcement actions we may take
- [Communications Guidelines](working-group-manual.md#communications-guidelines) - How we communicate with all parties
- [Record-Keeping Procedures](working-group-manual.md#record-keeping) - How we maintain records and protect privacy
...
Numbers of received reports and actions taken are published in the [statistics](statistics.md) section of this documentation to shed light on the volume of issues that the working group deals with.
...
1. **Being transparent about process** - Publishing how we work, not who we've investigated
2. **Providing aggregated data** - Sharing statistics that show patterns without identifying individuals
3. **Explaining decisions** - When appropriate, explaining the rationale behind policy changes or process updates
4. **Soliciting feedback** - Regularly asking the community for input on our processes and transparency measures
5. **Continuous improvement** - Regularly reviewing and updating our transparency practices
...
- **Ask questions** - If our processes or decisions are unclear, contact us at <conduct@djangoproject.com>
- **Contribute to documentation** - Our documentation is open source and accepts contributions (see [CONTRIBUTING.md](CONTRIBUTING.md))
