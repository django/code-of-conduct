...
Working Group enforces the Code of Conduct and how it all works behind the scenes.
...
- [Working Group Manual](working-group-manual.md) - Complete internal manual covering:
  - Report handling procedures
  - Communications guidelines
  - Record-keeping and confidentiality
  - Evaluation criteria and enforcement
- [Membership](membership.md) - Current and past working group members
- [Statistics](statistics.md) - Aggregated data on reports and outcomes

## Other

- [Contributing to this documentation](CONTRIBUTING.md)
- [Change log](CHANGELOG.md)
- [Sources](sources.md) - Documents and policies that inspired our approach
...
- [List of Code of Conduct working group members](https://www.djangoproject.com/foundation/committees/#conduct)
...
**Note:** The internal [Working Group Manual](working-group-manual.md) in this repository consolidates and expands upon the public enforcement manual with additional procedures and guidelines.
