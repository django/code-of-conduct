...
This FAQ attempts to address common questions and concerns around the Django community's [Code of Conduct](https://www.djangoproject.com/conduct/). If you still have questions after reading it, please feel free to [contact us](mailto:conduct@djangoproject.com).
...
However, we do expect that people will abide by the spirit and words of the CoC when in "official" Django spaces. This code has been adopted by both the Django core team and by the Django Software Foundation. That means that it'll apply both in community spaces _and_ at DSF events.
...
- [It has been broadly adopted by similar scale projects and organizations, providing a proven framework](https://www.contributor-covenant.org/adopters/)
...
This Code of Conduct also covers any events that the DSF funds. However, events funded by the DSF already [require a code of conduct](https://www.djangoproject.com/conduct/). Isn't this redundant?
...
So the DSF will require that any events it funds have some sort of anti- harassment policy in place. The DSF thinks the [Ada Initiative's template](http://geekfeminism.wikia.com/wiki/Conference_anti-harassment/Policy) is pretty good, but we're open to alternatives.

## What happens if someone violates the Code of Conduct?

Our intent is that anyone in the community can stand up for this code, and direct people who're unaware to this document. If that doesn't work, or if you need more help, you can contact [conduct@djangoproject.com](mailto:conduct@djangoproject.com). For more details please see our [Reporting Guidelines](https://www.djangoproject.com/conduct/reporting/).

When a violation is reported, the Code of Conduct Working Group investigates and determines an appropriate response using an [enforcement ladder](enforcement-ladder.md). This approach focuses on repairing harm and responding proportionally to the severity of the violation. The ladder has four levels: Warning, Temporary Suspension (Short-term), Temporary Suspension (Extended), and Permanent Ban as a last resort.
...
The [Code of Conduct Working Group](membership.md) is responsible for investigating reports and enforcing the Code of Conduct. The working group is appointed by the Django Software Foundation board and operates according to the procedures documented in the [Working Group Manual](working-group-manual.md).

For day-to-day moderation in Django's online spaces (like the forum and Discord), the [Online Community Working Group](https://github.com/django/dsf-working-groups/blob/main/active/online-community.md) handles issues using their own moderation processes. The Code of Conduct Working Group becomes involved for formal reports, cross-community violations, or issues escalated by the online moderators.
...
## What should I do if I've been accused of violating the Code of Conduct?
...
## Can someone be removed for behavior outside Django spaces?

The Code of Conduct applies to all Django-managed spaces and when someone is officially representing Django. However, as stated in the [Code of Conduct](https://www.djangoproject.com/conduct/), violations of this code outside these spaces may affect a person's ability to participate within them.
